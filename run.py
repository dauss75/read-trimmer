...
def init_parser():
    ...
    parser.add_argument("--out_r2", required = True, help = "Output file for R2 trimmed fastq")
    parser.add_argument("--out_metrics", required = True, help = "Output file path for trimming metrics")
    parser.add_argument("--primer_file", required = True, help = "Primer file with 3' coordinates" )
    parser.add_argument("--is-nextseq", action = "store_true", help = "Whether this is a NextSeq sequencing run")
    parser.add_argument("--check-primer-side", action = "store_true", help = "User primer side overlap coordinates for trimming R2 3' end")
    parser.add_argument("--tagname_primer", default = "pr" , help = "Tag name for Primer ID")
